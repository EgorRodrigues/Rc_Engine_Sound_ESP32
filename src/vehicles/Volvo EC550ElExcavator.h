...
#include "sounds/VolvoEC550ELidle.h" // Volvo EL550EL excavator
...
#ifdef REV_SOUND
#include "sounds/VolvoEC550ELrev.h" // Volvo EL550EL excavator
#endif
...
volatile int dieselKnockVolumePercentage = 500; // Adjust the Diesel knock volume (usually = 200 - 600%) 350
...
#include "sounds/VolvoEC550ELknock.h" // Volvo EL550EL excavator
...
volatile int hydraulicFlowVolumePercentage = 60; // Adjust the volume (usually = 60%)
...
uint32_t MAX_RPM_PERCENTAGE = 223; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
