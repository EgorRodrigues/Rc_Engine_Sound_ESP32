...
#define VEHICLE_NAME "Magirus Deutz 256 air cooled V8 Diesel truck"
...
#include "sounds/MagirusDeutz256Start.h" // Magirus Deutz 256
...
#include "sounds/MagirusDeutz256Idle.h" // Magirus Deutz 256
...
#ifdef REV_SOUND
#include "sounds/MagirusDeutz256Rev.h" // Magirus Deutz 256
#endif
...
volatile int jakeBrakeVolumePercentage = 170; // Adjust the max. volume (usually = 150%)
volatile int jakeBrakeIdleVolumePercentage = 50; // Adjust the min. volume (usually = 80%)
volatile int jakeBrakeMinRpm = 250; // Adjust the min. RPM for the jake brake (around 100)
#ifdef JAKE_BRAKE_SOUND
#include "sounds/MagirusDeutz256Jakebrake.h" // Magirus Deutz 256
#endif
...
volatile int dieselKnockVolumePercentage = 850; // Adjust the Diesel knock volume (usually = 200 - 600%) 700
...
#endif // ********************************************************************************
#include "sounds/MagirusDeutz256Knock.h" // Magirus Deutz 256
//#include "sounds/MagirusDeutz256Knock2.h" // Magirus Deutz 256
...
volatile int wastegateVolumePercentage = 150; // Adjust the wastegate volume (usually = 70%, up to 250%)
...
volatile int fanVolumePercentage = 30; // Adjust the fan volume (250% for Tatra 813, else 0%)
